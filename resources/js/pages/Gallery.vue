...
function openLightbox(photo: Photo) {
    if (activeAlbum.value === null) {
        // Grouped view: find index in flattened array
        const flattened = groupedPhotos.value.flatMap((g) => g.photos);
        lightboxIndex.value = flattened.findIndex((p) => p.id === photo.id);
    } else {
